...
Ambulance Services</a></h3>
									<p>24 hours patient transport vehicle available. Patients are transported from home (on campus) to Oaktree hospital and patients referred by emergency duty doctor to empanelled hospital for specialized case.</p>
								</div>
							</div>
						</div>
						<div class="col-md-4">
							<div class="about-grid n-about-grid n-about-grid1">
								...
								<div class="about-grid-info text-center">
									...
									<p>Trained laboratory staff are providing best services which includes painless blood withdrawal Services of one NABL accredited laboratory are also available for carrying out specialised tests.Sample collection time for Oaktree laboratory is 8 am to 10.30 am while emergency tests like Blood sugar, platelet count & Hb & blood grouping done in emergent cases throughout OPD hours.
</p>
								</div>
							</div>
						</div>
						...
						<div class="contact-grids">
							...
							<div class="col-md-5 contact-grid-left">
								<ul>
									...
									<li><span class="pin"> </span><label>Address :</label><small>#58 udoette street , uyo.  Nigeria</small></li>
									<li><span class="phone"> </span><label>Phone :</label><small>(234)-8086854662</small></li>	
									<li><span class="mail"> </span><label>Email :</label><small> Oaktree@gmail.com</small></li>
								</ul>
							</div>
							<div class="col-md-7 contact-grid-right">
								<form>
									<input type="text" value="Name" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Name:';}" autocomplete="off" >
									<input type="text" value="Email" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Email:';}"
									autocomplete="off">
									<input type="text" value="Phone Number" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Phone No:';}"
									autocomplete="off">
									<textarea rows="2" autocomplete="off" cols="70" onfocus="if(this.value == 'Message') this.value='';" onblur="if(this.value == '') this.value='Message';">Message</textarea>
