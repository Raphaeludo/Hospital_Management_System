    ...
    { 
        ...
        { 
		    ...
		    header("Location: admin/Admin.php"); 
			 ...
			 header("Location: nurse/Nursemod.php");
			 else if ($_POST['menu'] == 'Pharmacist' && $row['role']=="pharmacist")
			 header("Location: pharma/pharmacist.php");
...
<head>
    ...
    background-image: url("c.jpg"),url("d.jpg");
    background-repeat: no-repeat,no-repeat;
	background-position: bottom left,bottom right;
	background-position: 0px 0px,1100px 0px;
    }
...
<br/>									
								...
								<option>Accountant</option>
                                    ...
                                    <a class="pull-right" href="index.php" >HomePage</a>
